...
@section('message', ($customMessage ?? 'Sistem menahan sementara permintaan berulang untuk menjaga performa dan mencegah spam database.').' Coba lagi dalam '.$waitText.'.')
@section('details')
    ...
    <div class="rounded-[20px] border-2 border-[#2B2250]/15 bg-white/85 p-4 shadow-[6px_6px_0_0_rgba(197,212,255,0.75)] dark:border-white/10 dark:bg-[#130F29]/85 dark:shadow-[6px_6px_0_0_rgba(8,6,18,0.75)]">
        ...
        <p class="mt-2 text-sm leading-6 text-[#4A4567] dark:text-[#D7D2F5]">
            Hindari klik tombol simpan berulang, lalu ulangi aksi setelah {{ $waitText }}.
        </p>
    </div>
@endsection
