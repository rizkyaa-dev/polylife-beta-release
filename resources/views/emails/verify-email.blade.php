...
<body style="margin:0;padding:0;background-color:#f4f6fb;color:#172033;font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;-webkit-text-size-adjust:100%;text-size-adjust:100%;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">
        Tinggal satu langkah lagi untuk mengaktifkan akun {{ $brandName }} kamu.
    </div>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td align="center" style="padding:0 0 22px;">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto;">
                                            <tr>
                                                <td align="center" style="width:64px;height:64px;border-radius:50%;background-color:#eef0ff;color:#5148e5;font-size:34px;line-height:64px;font-weight:800;">
                                                    &#10003;
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <p style="margin:14px 0 0;color:#526071;font-size:16px;line-height:1.65;font-weight:400;">
                                            Klik tombol di bawah untuk memverifikasi email dan mulai menggunakan akun kamu.
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" style="padding:30px 0 16px;">
                                        <a href="{{ $verificationUrl }}" class="email-button" style="display:inline-block;background-color:#5148e5;border-radius:12px;color:#ffffff;font-size:16px;line-height:1.2;font-weight:800;text-decoration:none;padding:16px 30px;min-width:240px;text-align:center;">
                                            Verifikasi Email
                                        </a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:20px;border:1px solid #e4e7f0;border-radius:14px;background-color:#f8f9fc;">
                                        ...
                                        <p class="email-link-box" style="margin:0;color:#5148e5;font-size:13px;line-height:1.55;word-break:break-all;overflow-wrap:anywhere;">
                                            <a href="{{ $verificationUrl }}" style="color:#5148e5;text-decoration:underline;">{{ $verificationUrl }}</a>
                                        </p>
                                    </td>
                                </tr>
