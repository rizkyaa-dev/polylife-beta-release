                    ...
                    <tr>
                        <td style="padding:28px 30px 24px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:24px 0 16px;">
                                <tr>
                                    <td>
                                        <a href="{{ $verificationUrl }}" style="display:inline-block;padding:13px 24px;border-radius:12px;background-color:#8181ff;border:2px solid #2b2250;color:#ffffff;font-size:14px;font-weight:700;letter-spacing:0.4px;text-decoration:none;">
                                ...
                                <tr>
                                    <td style="padding:14px 14px 10px;">
                                        ...
                                        <p style="margin:0;font-size:13px;line-height:1.6;color:#4c4c63;word-break:break-all;">
                                            ...
                                            <a href="{{ $verificationUrl }}" style="color:#5a57c9;text-decoration:underline;">{{ $verificationUrl }}</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
