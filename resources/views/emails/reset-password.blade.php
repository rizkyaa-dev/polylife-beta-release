                    ...
                    <tr>
                        <td class="email-section" style="padding:30px 30px 24px;background-color:#ffffff;">
                            <p style="margin:0 0 24px;color:#25224c;font-size:16px;line-height:1.7;font-weight:400;">
                                Klik tombol di bawah untuk membuat password baru. Demi keamanan, tautan ini hanya berlaku dalam waktu terbatas.
                            </p>

                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 0 18px;">
                                <tr>
                                    <td>
                                        <a href="{{ $resetUrl }}" class="email-button" style="display:inline-block;min-width:180px;padding:14px 22px;border-radius:11px;background-color:#7b72f4;border:2px solid #25205f;box-shadow:0 4px 0 #25205f;color:#ffffff;font-size:15px;line-height:1.2;font-weight:800;text-align:center;text-decoration:none;">
                                            Atur Ulang Password
                                        </a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:15px 15px 14px;">
                                        ...
                                        <p style="margin:0;color:#3f3bd6;font-size:14px;line-height:1.55;word-break:break-all;overflow-wrap:anywhere;">
                                            <a href="{{ $resetUrl }}" style="color:#3f3bd6;text-decoration:underline;">{{ $resetUrl }}</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
