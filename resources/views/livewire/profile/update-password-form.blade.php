...
<section>
    <header class="space-y-1">
        ...
        <p class="text-sm text-gray-500 dark:text-slate-400">
            Gunakan password yang panjang dan berbeda dari layanan lain.
        </p>
    </header>
    ...
    <form wire:submit="updatePassword" class="mt-6 space-y-6">
        ...
        <div class="flex flex-wrap items-center gap-4">
            ...
            <x-action-message class="text-sm font-medium text-emerald-600 dark:text-emerald-300" on="password-updated">
                Tersimpan.
            </x-action-message>
        </div>
    </form>
