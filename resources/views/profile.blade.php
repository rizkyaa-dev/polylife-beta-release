    ...
    <section class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div class="flex min-w-0 items-center gap-4">
                <div class="h-20 w-20 shrink-0 overflow-hidden rounded-3xl border border-indigo-100 bg-indigo-50 text-2xl font-bold text-indigo-700 shadow-sm dark:border-indigo-500/20 dark:bg-indigo-500/10 dark:text-indigo-100">
                    @if ($avatarUrl)
                ...
                <div class="min-w-0">
                    ...
                    <h2 class="mt-1 break-words text-2xl font-bold text-gray-900 dark:text-slate-100">{{ $displayName }}</h2>
