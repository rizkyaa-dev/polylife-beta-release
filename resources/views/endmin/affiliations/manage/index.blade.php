...
<div class="space-y-6">
    ...
    <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <form method="GET" action="{{ route('endmin.affiliations.manage.index') }}" class="grid gap-3 md:grid-cols-[minmax(0,1fr)_12rem_auto]">
            <div>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-slate-800">
                    @forelse ($templates as $template)
                        <tr>
                            ...
                            <td class="py-3 pr-4 font-semibold text-slate-900 dark:text-slate-100">{{ $template->affiliation_name }}</td>
                            <td class="py-3 pr-4">
