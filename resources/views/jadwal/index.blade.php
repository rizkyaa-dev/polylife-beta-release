...
@section('content')
    ...
    <div class="min-w-0 space-y-8">
        <section class="min-w-0 overflow-hidden rounded-3xl border border-indigo-100 bg-gradient-to-br from-indigo-50 via-white to-white p-6 shadow-sm dark:border-slate-800 dark:from-[#111827] dark:via-[#0f172a] dark:to-[#0f172a] dark:shadow-none">
